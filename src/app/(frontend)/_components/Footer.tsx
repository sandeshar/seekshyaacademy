        ...
        <footer className="bg-white border-t border-slate-200 pt-16 pb-8">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
                        ...
                        <div key={`section-${idx}`}>
                            ...
                            <ul className="space-y-2 text-sm text-slate-500">
                                {section.links?.map((link: any, i: number) => (
                                    <li key={i}>
                                        <Link className="hover:text-primary transition-colors font-medium" href={link.href}>
                                            {link.label}
                                        </Link>
                                    </li>
                                ))}
                    ...
                    <div>
                        <h3 className="text-slate-900 font-bold mb-4">Contact Info</h3>
                ...
                <div className="border-t border-slate-200 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
                    <div className="flex flex-col md:flex-row gap-2 md:gap-4 text-center md:text-left">
                        <p className="text-slate-400 text-sm">© <CurrentYear /> {settings.siteName}. All rights reserved.</p>
                    ...
                    <div className="flex gap-6">
                        {activeSocialLinks.facebook && (
                            <Link className="text-slate-400 hover:text-primary transition-colors" href={activeSocialLinks.facebook} target="_blank">
                        ...
                        {activeSocialLinks.instagram && (
                            <Link className="text-slate-400 hover:text-primary transition-colors" href={activeSocialLinks.instagram} target="_blank">
                        ...
                        {activeSocialLinks.linkedin && (
                            <Link className="text-slate-400 hover:text-primary transition-colors" href={activeSocialLinks.linkedin} target="_blank">
                        ...
                        {activeSocialLinks.twitter && (
                            <Link className="text-slate-400 hover:text-primary transition-colors" href={activeSocialLinks.twitter} target="_blank">
                        ...
                        {activeSocialLinks.youtube && (
                            <Link className="text-slate-400 hover:text-primary transition-colors" href={activeSocialLinks.youtube} target="_blank">
                        ...
                        {activeSocialLinks.whatsapp && (
                            <Link className="text-slate-400 hover:text-primary transition-colors" href={`https://wa.me/${activeSocialLinks.whatsapp.replace(/\D/g, '')}`} target="_blank">
