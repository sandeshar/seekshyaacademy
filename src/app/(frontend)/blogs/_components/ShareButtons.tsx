...
const ShareButtons: React.FC<ShareButtonsProps> = ({ title, url, hideTitle = false }) => {
    ...
    return (
        <div className="flex flex-col gap-3">
            {!hideTitle && <h3 className="text-sm font-bold text-slate-800 font-lexend">Share this article</h3>}
            <div className="flex flex-wrap items-center gap-2">
                ...
                <button
                    ...
                    className={`flex items-center justify-center w-10 h-10 rounded-full transition-all ${copied
